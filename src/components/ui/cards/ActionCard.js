...
const ActionCard = ({ title, description, image, direction, cardStyling, textContainerStyle, onClick, isDisabled }) => {
  const cardStyle = {
  ...
  return (
    <div className={`bg-green card justify-between ${cardStyling}`} style={cardStyle}>
      ...
      <button className="card-content" onClick={onClick} disabled={isDisabled}>
